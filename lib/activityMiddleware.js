...
const checkUserActivity = async (req, res, next) => {
  // TEMPORARILY DISABLED FOR TESTING - JUST VERIFY TOKEN
  try {
    ...
    try {
      ...
      console.log("=== ACTIVITY CHECK BYPASSED ===");
      console.log("User email:", user.email);
      console.log("Activity check disabled for testing");

      // SKIP ACTIVITY TIMEOUT CHECK - JUST UPDATE ACTIVITY
